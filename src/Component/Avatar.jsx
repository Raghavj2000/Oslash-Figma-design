...
export default function Avatar() {
  return (
    <Menu as="div" className="relative inline-block text-left pl-2">
      ...
      >
        <Menu.Items className="absolute right-0 mt-2 p-2  w-56 origin-top-right divide-y divide-gray-100 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <>
            <Menu.Item>
              {({ active }) => (
                <button
